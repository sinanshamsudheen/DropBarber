      ...
      <div className="flex flex-wrap gap-3">
        ...
        {photos.length < max && (
          <div className="flex w-28 flex-col gap-2">
            <label
              htmlFor={inputId}
              className="grid aspect-[3/4] cursor-pointer place-items-center rounded-md border border-dashed border-hairline bg-card text-muted-foreground transition-colors hover:border-ink hover:text-ink"
            >
