...
import type { HydratedAppointment } from "@/hooks/appointment-hydration";
    ...
    >
      <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3">
        <div className="min-w-0">
          <h3 className="type-title-md truncate text-ink">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-sm text-muted-foreground">
        ...
        <span className="inline-flex items-center gap-1.5">
          ...
          {timeLabel(appointment.time)} · {appointment.durationMin} min
        </span>
        <span className="inline-flex items-center gap-1.5">
        ...
        {appointment.referencePhotos.length > 0 && (
          <span className="inline-flex items-center gap-1.5 text-brand">
            ...
            {appointment.referencePhotos.length} reference
          </span>
        )}
