...
import { getManagedBarber, setBarberService } from "@/lib/api";
...
function BarberDetail() {
  ...
  return (
    <div className="space-y-6">
      <button
        onClick={() => void navigate({ to: "/manage/$shopId/barbers", params: { shopId } })}
      ...
      <section>
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3">
          ...
          <Button asChild size="sm" variant="outline">
            <Link to="/manage/$shopId/schedule" params={{ shopId }} search={{ barberId }}>
